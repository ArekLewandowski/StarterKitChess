...
public class QueenMoveValidatonTests {
	...
	@Test
	public void shouldReturnQueenCapture3() throws InvalidMoveException {
		// given
		Board board = new Board();
		board.setPieceAt(Piece.WHITE_QUEEN, new Coordinate(1, 1));
		board.setPieceAt(Piece.BLACK_KNIGHT, new Coordinate(3, 3));
	...
	@Test
	public void shouldReturnQueenAttack6() throws InvalidMoveException {
		// given
		Board board = new Board();
		board.setPieceAt(Piece.WHITE_QUEEN, new Coordinate(1, 1));
		board.setPieceAt(Piece.BLACK_KNIGHT, new Coordinate(3, 3));
